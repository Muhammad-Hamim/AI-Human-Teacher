 ...
 * @access Private
 */
router.post("/stream-message", ChatController.streamMessage);
 ...
 * @access Private
 */
router.get("/tts-voices", ChatController.getTTSVoices);
 ...
 * @access Private
 */
router.get("/stream-audio/:messageId", ChatController.streamAudioFile);
